...
// import CloudEvents from '../../icons/untitled-ui/duocolor/cloud-events';
// import Processes from '../../icons/untitled-ui/duocolor/processes';
...
export const getSections = (t: any) => [
  ...
  },
  {
    ...
    items: [
      ...
      // },
      // {
      //   title: t(tokens.nav.processList),
      //   path: paths.processes.index,
      //   icon: (
      //     <SvgIcon fontSize="small">
      //       <Processes />
      //     </SvgIcon>
